...
<BeeComposedChart xDataKey="month" data={data} config={chartConfig}>
  <Grid />
  <XAxis dataKey="month" />
  <YAxis />
  <Legend />
...
<ApiTable>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof ComposedChart>">
    Additional ECharts options merged into the compiled `option` by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series" _blank>ECharts ComposedChart documentation</Link> for available props.
  </ApiRow>
</ApiTable>
