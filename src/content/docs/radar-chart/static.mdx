...
<ApiTable>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof RadarChart>">
    Additional ECharts options merged into the compiled `option` by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-radar" _blank>ECharts RadarChart documentation</Link> for available props.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="radarProps" type='Omit<ComponentProps<typeof Radar>, "dataKey">'>
    Additional ECharts options merged into the compiled `option` by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-radar" _blank>ECharts Radar documentation</Link> for available props.
  </ApiRow>
</ApiTable>
