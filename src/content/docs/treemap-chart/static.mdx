...
<ApiTable>
  ...
  <ApiRow name="treemapProps" type='Omit<TreemapProps, "data" | "dataKey">'>
    Additional ECharts treemap options (`data`, `dataKey`, labels, gradients, strokes, naming keys, and sizing already owned by BeeTreemap internals). Read the <Link href="https://echarts.apache.org/en/option.html#series-treemap" _blank>ECharts treemap documentation</Link> for available escape hatches.
  </ApiRow>
</ApiTable>
