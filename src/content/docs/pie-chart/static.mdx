...
<ApiTable>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof PieChart>">
    Additional ECharts options merged into the compiled `option` by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-pie" _blank>ECharts PieChart documentation</Link> for available props.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="pieProps" type='Omit<ComponentProps<typeof Pie>, "data" | "dataKey" | "nameKey">'>
    Escape hatch for raw ECharts series options compiled by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-pie" _blank>ECharts Pie documentation</Link> for available props.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="labelListProps" type='Omit<ComponentProps<typeof LabelList>, "dataKey">'>
    Escape hatch for raw ECharts series options compiled by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-pie.label" _blank>ECharts LabelList documentation</Link> for available props.
  </ApiRow>
</ApiTable>
