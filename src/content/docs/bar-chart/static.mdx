...
<BeeBarChart data={data} config={chartConfig} xDataKey="month">
  <Grid />
  <XAxis dataKey="month" />
  <Legend />
  <Tooltip />
...
<ApiTable>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof BarChart>">
    Additional ECharts options merged into the compiled `option` by BeeCharts. Read the <Link href="https://echarts.apache.org/en/option.html#series-bar" _blank>ECharts BarChart documentation</Link> for available props.
  </ApiRow>
</ApiTable>
