        ...
        <div className="flex h-fit flex-col gap-2 pt-2">
          {toc.map((item) => (
            <a
              key={item.url}
              href={item.url}
              className="toc-item text-muted-foreground/75 hover:text-foreground data-[active=true]:text-foreground text-[0.8rem] no-underline transition-colors duration-200 empty:hidden data-[active=true]:font-medium data-[depth=1]:pl-5 data-[depth=2]:pl-5 data-[depth=3]:pl-8 data-[depth=4]:pl-11"
