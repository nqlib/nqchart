...
export type NQChartBrushProps<TData extends Record<string, unknown>> = {
  data: TData[];
...
export function NQChartBrush<TData extends Record<string, unknown>>({
  data,
  compile,
  rootFields = {},
  startIndex,
