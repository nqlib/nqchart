...
const GraphPaperPattern = ({ id }: PatternProps) => (
  <pattern id={id} x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
    <path
...
const DiagonalLinesPattern = ({ id }: PatternProps) => (
  ...
  >
    <line x1="0" y1="0" x2="0" y2="6" stroke="currentColor" strokeWidth="0.5" className="text-border" />
  </pattern>
);
...
const PATTERN_MAP: Record<BackgroundVariant, FC<PatternProps>> = {
  dots: DotsPattern,
  "graph-paper": GraphPaperPattern,
  plus: PlusPattern,
