...
Install with `npx shadcn@latest add @beecharts/<block-name>`.
...
| `ex-heatmap-chart` | `BeeHeatmapChart` + `prepareHeatmapCells` |
...
| `ex-calendar-workload-chart` | `BeeCalendarChart` |
...
| **sankey** | `ex-sankey-chart`, `ex-labeled-nodes-sankey-chart`, `ex-glowing-sankey-chart`, `ex-loading-state-sankey-chart`, … |
